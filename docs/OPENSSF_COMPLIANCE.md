...
wget https://github.com/ByronWilliamsCPA/audio_processor/releases/download/v1.0.0/package.whl
wget https://github.com/ByronWilliamsCPA/audio_processor/releases/download/v1.0.0/package.whl.sig
wget https://github.com/ByronWilliamsCPA/audio_processor/releases/download/v1.0.0/package.whl.pem

# Verify signature
cosign verify-blob \
  --certificate package.whl.pem \
  --signature package.whl.sig \
  --certificate-identity-regexp="https://github.com/ByronWilliamsCPA/audio_processor" \
...
wget https://github.com/ByronWilliamsCPA/audio_processor/releases/download/v1.0.0/attestation.intoto.jsonl

# Verify with slsa-verifier
slsa-verifier verify-artifact package.whl \
  --provenance-path attestation.intoto.jsonl \
  --source-uri github.com/ByronWilliamsCPA/audio_processor
```
...
1. Go to: `https://github.com/ByronWilliamsCPA/audio_processor/settings/branches`
...
- ✅ Full project documentation (README, CONTRIBUTING, SECURITY, CHANGELOG)
- ✅ HTTPS for all sites
...
**Security Questions**: byron@williamshome.family
**Vulnerability Reports**: See [Security Policy](https://github.com/ByronWilliamsCPA/.github/blob/main/SECURITY.md)
**General Issues**: [GitHub Issues](https://github.com/ByronWilliamsCPA/audio-processor/issues)
