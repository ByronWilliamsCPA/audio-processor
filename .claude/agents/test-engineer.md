...
- Max iterations: 5 generation cycles per invocation
- Timeout: 30 minutes per test generation session
- Token budget: Scope to the module under test and its direct dependencies; do not load unrelated modules
