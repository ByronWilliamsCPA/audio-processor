...
- Max iterations: 5 scan cycles per invocation
- Timeout: 30 minutes per audit session
- Token budget: Scope to the src/ directory and changed files; skip vendored dependencies
