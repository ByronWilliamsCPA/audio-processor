...
- Max iterations: 5 review cycles per invocation
- Timeout: 30 minutes per review session
- Token budget: Focus on files changed in the current PR; do not scan the full codebase
