...
- `audio_processor/path/to/file.ext`
...
`audio_processor/.github/workflows/`.

**Affected Files**:
- `audio_processor/.github/workflows/ci.yml`
- `audio_processor/.github/workflows/release.yml`
- `audio_processor/.github/workflows/docs.yml`
