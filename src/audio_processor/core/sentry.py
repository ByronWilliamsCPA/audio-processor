...
def before_send_hook(event: SentryEvent, hint: SentryHint) -> SentryEvent | None:
    ...
    Args:
        event (SentryEvent): Sentry event dictionary
        hint (SentryHint): Additional information about the event

    Returns:
        SentryEvent | None: Modified event dictionary, or None to drop the event
    """
...
def before_breadcrumb_hook(
    ...
    Args:
        crumb (SentryBreadcrumb): Breadcrumb dictionary
        hint (SentryHint): Additional information about the breadcrumb

    Returns:
        SentryBreadcrumb | None: Modified breadcrumb dictionary, or None to drop the breadcrumb
    """
...
def capture_exception(
    ...
    *,
    ...
    Args:
        ...
        extra (SentryExtra | None): Additional context data
...
def set_user_context(
    ...
    **kwargs: str | int | float | bool | None,
    ...
    Args:
        ...
        **kwargs (str | int | float | bool | None): Additional user attributes
...
def add_breadcrumb(
    ...
    Args:
        ...
        data (SentryExtra | None): Additional data
