...
Audio Processor exception hierarchy, covering:
...
class TestResourceNotFoundError:
    ...
    def test_basic_initialization(self) -> None:
        ...
        from audio_processor.core.exceptions import ResourceNotFoundError
...
class TestAuthenticationError:
    ...
    def test_default_message(self) -> None:
        ...
        from audio_processor.core.exceptions import AuthenticationError
...
class TestAuthorizationError:
    ...
    def test_default_message(self) -> None:
        """Verify default message is used when not provided."""
        from audio_processor.core.exceptions import AuthorizationError
...
class TestExternalServiceError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from audio_processor.core.exceptions import ExternalServiceError
...
class TestAPIError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from audio_processor.core.exceptions import APIError
...
class TestBusinessLogicError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from audio_processor.core.exceptions import BusinessLogicError
...
class TestModuleExports:
    ...
    def test_all_exceptions_exported(self) -> None:
        ...
        from audio_processor.core import exceptions
